...
class MailuClient{
    ...
    */
    createRelay(body){
        return this.useAxios('post', `/relay`, body);
    };
    ...
    */
    updateRelay(name, body){
        return this.useAxios('patch', `/relay/${name}`, body);
    };
    ...
    */
    getRelay(name){
        return this.useAxios('get', `/relay/${name}`);
    };
    ...
    */
    deleteRelay(name){
        return this.useAxios('delete', `/relay/${name}`);
    };
};
